...
from .models import Facilitador, Periodo, Taller
...
class TallerForm(forms.ModelForm):
    ...
    class Meta:
        model = Taller
        fields = ['nombre_taller', 'descripcion', 'fecha_inicio', 'fecha_fin', 'hora_inicio', 'hora_fin', 'cupos', 'grupo', 'facilitador', 'periodo',]
        widgets = {
